...
#run function and link to variable so we can use the index in link_by_id ?
...
#l = Link(50, 60398, 1334014208.0, 109, "title", "url")
#call Link() within add new link, as within "Links" list, there is the concept of a Link()
add_new_link(Link(50, 60398, 1334014208.0, 109, "title", "url"))
