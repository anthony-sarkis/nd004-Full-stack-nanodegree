...
folder = os.getcwd()
client_secrets_json_path = folder + '/methods/login/client_secrets.json'

CLIENT_ID = json.loads(open(client_secrets_json_path, 'r').read())[
    'web']['client_id']
APPLICATION_NAME = "Catalog Application"


@routes.route('/gconnect', methods=['POST'])
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(
            client_secrets_json_path, scope='')
    ...
    # List provider
    login_session['provider_google'] = 'google'
